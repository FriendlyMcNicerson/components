...
public class MarketoBaseTestIT {
    ...
    protected static String ENDPOINT_SOAP;

    protected static String USERID_SOAP;

    protected static String SECRETKEY_SOAP;

    protected static String ENDPOINT_REST;

    protected static String USERID_REST;

    protected static String SECRETKEY_REST;
    ...
    public static TMarketoOutputProperties initClient() throws Exception {
        ...
        p.operation.setValue(Operation.syncLead);
